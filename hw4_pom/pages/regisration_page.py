from pytest_course.hw4_pom.base.seleniumbase import BasePage
from pytest_course.hw4_pom.tests.registration.locators import HEADER, START_TESTING_BUTTON, LOGIN_FIELD, \
    PASSWORDD_FIELD, AGREE_CHECKBOX, REGISTRATION_BUTTON, LOADER, SUCCESS_MESSAGE
